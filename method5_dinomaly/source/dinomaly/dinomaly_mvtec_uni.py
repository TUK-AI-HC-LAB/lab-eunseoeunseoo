...
def train(item_list):
    ...
    # protocol change: original batch_size=16 at image_size=448/crop=392 was tuned for an
    # RTX 3090 (24GB, per repo README). Reduced for local 8GB GPU (same reasoning as
    # method3_diad/method4_glad's batch reductions) -- see method5_dinomaly/markdown/setup_notes.md.
    total_iters = 10000
    batch_size = 16
    image_size = 448
    crop_size = 392
    ...
    # num_workers 4->0: Windows spawn multiprocessing issue, same fix as method3_diad/method4_glad.
