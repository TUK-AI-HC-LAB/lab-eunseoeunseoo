...
## 2026-W26 (6/22 ~ 6/28)
- Meeting material: [meetings/2026-W27_brief.md](meetings/2026-W27_brief.md)

### Completion of previous week's plan
- N/A (first week)

### Decisions from the previous meeting
- Joined the lab as an undergraduate research student
- IAD identified as preferred research direction; PatchCore assigned as first method to reproduce
- [Remaining decisions to be filled in after W26 meeting]
...
## 2026-W27 (6/29 ~ 7/5)
- Meeting material: [meetings/2026-W28_brief.md](meetings/2026-W28_brief.md)

### Completion of previous week's plan
- [x] Set up personal repository structure
- [x] Read PatchCore paper and write summary
- [x] Reproduce PatchCore baseline on all 15 MVTec AD categories
- [x] Write baseline analysis note
- [ ] Decide next sub-direction (A/B/C) → W27 meeting pending (no feedback yet)
